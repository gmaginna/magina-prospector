export const LEAD_HEADERS = [
  "Data de cadastro", "Empresa", "Cidade", "Segmento / o que vende", "Site / URL", "Telefone / WhatsApp", "Instagram",
  "Responsável / decisor", "Como encontrou", "Tem site?", "Tem domínio próprio?", "Qualidade do site", "Funciona bem no celular?",
  "WhatsApp fácil?", "Instagram ativo?", "Avaliações no Google", "Anuncia no Google?", "Anuncia no Facebook/Instagram?",
  "Para onde o anúncio leva?", "O anúncio leva para página específica do serviço?", "Produto/serviço tem bom valor?", "Problema encontrado",
  "Pontuação", "Prioridade", "Sugestão automática", "Pacote oferecido", "Implantação sugerida", "Mensalidade sugerida",
