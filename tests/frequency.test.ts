...
import { formatScheduleDate, nextRunDate, parseScheduleDate, priorityIntervalDays } from "../src/rotation/frequency.js";
...
describe("search frequency dates", () => {
  ...
  it("calculates the next run from last execution and priority", () => {
    expect(nextRunDate("23/09/2026", 1, now)).toBe("22/11/2026");
    expect(nextRunDate("23/09/2026", 2, now)).toBe("22/12/2026");
    expect(nextRunDate("23/09/2026", 3, now)).toBe("21/01/2027");
  });
